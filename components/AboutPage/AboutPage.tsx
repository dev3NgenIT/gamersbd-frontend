...
const teamMembers = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1494790108777-2961285e9489?w=400&auto=format&fit=crop",
    social: {
      github: "#",
      twitter: "#",
      linkedin: "#"
  ...
  },
  {
    ...
    quote: "Technology should enhance the gaming experience, not complicate it."
  },
  {
    id: 4,
    name: "Emma Davis",
  ...
  },
  {
    ...
    expertise: ["Esports Strategy", "Tournament Analysis", "Player Development"],
...
const milestones = [
  {
    year: "2020",
    title: "The Beginning",
    description: "Started as a small gaming blog with a vision to create authentic gaming content.",
    icon: Rocket
  },
  {
    year: "2021",
    title: "First Milestone",
    description: "Reached 100,000 monthly readers and launched our YouTube channel.",
    icon: Users
  },
  {
    year: "2022",
    title: "Team Expansion",
    description: "Grew to 15 team members and expanded to cover esports events.",
    icon: Briefcase
  },
  {
    year: "2023",
    title: "Global Recognition",
    description: "Won 'Best Gaming Content Creator' award at the Gaming Industry Awards.",
    icon: Award
  },
  {
    year: "2024",
    title: "Community First",
    description: "Launched our community platform with over 50,000 active members.",
    icon: Heart
  },
  {
    year: "2025",
...
const values = [
  {
    icon: Target,
    title: "Our Mission",
    description: "To create the most trusted and engaging gaming platform where players can discover, learn, and connect.",
    color: "from-purple-500 to-indigo-500"
  },
  {
    icon: Eye,
    title: "Our Vision",
    description: "A world where every gamer has access to quality content and a supportive community.",
    color: "from-indigo-500 to-blue-500"
  },
  {
    icon: Heart,
    title: "Our Passion",
    description: "We live and breathe gaming. Every review, guide, and article comes from genuine love for the craft.",
    color: "from-pink-500 to-rose-500"
  },
  {
    icon: Shield,
    title: "Integrity",
    description: "Honest reviews, transparent partnerships, and putting our community first in every decision.",
...
const testimonials = [
  {
    ...
    role: "Game Developer",
    content: "The most authentic gaming content I've found. Their reviews are honest and detailed.",
  ...
  },
  {
    ...
    content: "I've been following them for years. Their esports coverage is unmatched.",
  ...
  },
  {
    ...
    content: "The community they've built is incredible. Always helpful and welcoming.",
  ...
  return (
    ...
    >
      ...
      <div className="relative h-80 overflow-hidden">
        ...
        <div className={`absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2 z-20 transition-all duration-500 ${
          isHovered ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
          <a href={member.social.github} className="w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-purple-600 transition-all duration-300 border border-white/20">
        ...
        >
          {isPlaying ? <Pause className="w-4 h-4 text-white" /> : <Quote className="w-4 h-4 text-white" />}
        </button>
    ...
    <div className="min-h-screen bg-[#1a1a1a]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              We're on a mission to create the ultimate gaming community where passion meets expertise, 
              and every gamer feels at home.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              Founded in 2020 by a group of passionate gamers, GameChangers started as a small blog 
              sharing honest game reviews. Today, we've grown into a global community of millions, 
              but our core values remain the same: authenticity, passion, and community first.
            </p>
            <p className="text-gray-300 text-lg leading-relaxed mb-8">
              We believe that gaming is more than just entertainment – it's a way to connect, learn, 
              and grow. Every review, guide, and article we create is driven by our love for gaming 
              and our commitment to helping you make the most of your gaming journey.
            </p>
            ...
            <div className="relative bg-[#2A2A2A] rounded-3xl overflow-hidden border border-gray-800">
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="text-white font-semibold">Our Journey in 2 Minutes</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Our values guide everything we do, from content creation to community building.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Passionate gamers, writers, and creators working together to bring you the best content.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-600/20 via-indigo-600/20 to-purple-600/20 rounded-3xl p-12 border border-purple-500/30 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Be part of something amazing. Connect with fellow gamers, get exclusive content, and stay updated.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-medium rounded-xl transition-all duration-300 transform hover:scale-105">
                Join Now
              </button>
              <button className="px-8 py-4 border border-gray-700 hover:border-purple-500 text-gray-300 hover:text-white font-medium rounded-xl transition-all duration-300">
                Contact Us
              </button>
            </div>
          </div>
